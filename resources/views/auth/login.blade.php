...
@section('title', 'Inicio de Sessão')
@section('subtitle','Insira os seus dados para iniciar sessão.')
                ...
                <div class="card-body px-lg-5 py-lg-5">
                   @if($errors->any())
                        <div class="text-center text-muted mb-4">
                            <small>Opps! Foi encontrado um erro.</small>
                        </div>
                  ...
                  <form role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="custom-control custom-control-alternative custom-checkbox">
                      ...
                      <label class="custom-control-label" for="remember">
                        <span class="text-muted">Recordar sessão</span>
                      </label>
                    </div>
              ...
              <div class="row mt-3">
                ...
                <div class="col-6 text-right">
                  <a href="{{ route('register') }}" class="text-light">
                    <small>Ainda não se registou?</small>
                  </a>
                </div>
              </div>
            </div>
